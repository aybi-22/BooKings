...
public class WellnessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wellness); // Stellen Sie sicher, dass Sie das richtige Layout haben
    ...
    private void bookSlot() {
        Intent intent = new Intent(this, PersonalData.class); // Stellen Sie sicher, dass es eine ConfirmationActivity gibt oder ändern Sie das Ziel entsprechend.
    ...
    private void goBack() {
        finish(); // Einfach die aktuelle Aktivität beenden, um zurückzugehen
    }
}
