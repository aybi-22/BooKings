...
public class Eventroom extends AppCompatActivity {
    ...
    private Button bookEventroomButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookEventroomButton = findViewById(R.id.bookButton);
        ...
        bookEventroomButton.setOnClickListener(v -> bookSlot());
    ...
    private void bookSlot() {
        // Hier wird Ihre Buchungslogik implementiert.
